...
class SensorData(models.Model):
    ...
    deviceName = models.CharField(max_length=100, help_text="Nama perangkat sensor")
    ...
    def __str__(self):
        return f"{self.deviceName} ({self.deviceId}) - {self.temperature}°C, {self.humidity}% - {self.timestamp}"
